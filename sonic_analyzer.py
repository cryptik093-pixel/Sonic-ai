"""
Legacy Sonic analyzer wrapper.

This script now delegates to the unified analyzer so the project has a single
stable analysis path instead of multiple prototype implementations.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Analyze audio with Sonic AI.")
